-- HexFlow UCTV first release
-- Edited from HexFlow Launcher Custom version 2.2, please support BlackSheepBoy69 great work.
...
--@@ I need to check if you can overclocked by default for PSTV
...
function load_RetroFlow()
  ...
  --end
--@@ I may trim this just focus on PS Consoles
...
-- READ SETTINGS
--@@ I really like having these many options
...
while true do
  ...
  --end
	...
	elseif getBGround == 7 then
	    BGroundText = lang_lines[74] --Original
	...
	PrintCentered(fnt22, 60+140+560, 79 + 374, sanitize(lang_lines[13]), white, 22)--More Information (About)
		...
		-- [1]=Custom, [2]=Citylights, [3]=Aurora, [4]=Crystal, [5]=Wood, [6]=Dark, [7]=Original, [8]=Retro.
