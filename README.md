...
<p>&nbsp;</p>
<h3>IMPORTANT</h3>
<p>For PSP bubbles generated by Adrenaline Bubbles Manager you must set the value of <strong>BubbleID</strong> to <strong>TitleID</strong> in the settings menu of ABM tool. In v1.1 and above, PS1 and most PSP (.iso or .pbp only) Bubble ID doesn't matter because it's scanned in binary during the startup.</p>
