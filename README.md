...
<p>⚫Rename a game via the triangle menu. Great for japanese-translated-to-English games where the translators were too lazy to translate the app title in the param.sfo (low priority). ✔️Done, coming in next release; you do the actual renaming by editting a file in your data folder, the triangle menu renamer is only used to reset it back to normal.</p>
